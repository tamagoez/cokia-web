...
export default function ToUJAPage() {
  return (
    <>
      <Heading>Cokia 利用規約</Heading>
      <Text>
        <b>
          分かりづらいと思われるので、こちらを参考にしてください: 現在準備中
        </b>
        <br />
        この利用規約（以下，「本規約」といいます。）は，Cokia（以下，「当社」といいます。）がこのウェブサイト上で提供するサービス（以下，「本サービス」といいます。）の利用条件を定めるものです。
        <br />
        ...
        <br />
        ただし1人の管理者が管理しているため、最長で2ヵ月退会処理がかかる場合があるためご了承ください。
